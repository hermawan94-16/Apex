...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Dev > Madati Store${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}MADATI® ${NC}${YELLOW}(${NC} ${green} 🇮🇩MADATI🇮🇩  ${NC}${YELLOW})${NC}"
echo -e " © Recode By My Self Madati_Store ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/hermawan94-16/Apex/ZX/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/hermawan94-16/Apex/ZX/REGISTRASI"
# USERNAME
rm -f /usr/bin/user
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/6285171661994"}]]}' 
...
wget -q https://raw.githubusercontent.com/hermawan94-16/Apex/ZX/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
